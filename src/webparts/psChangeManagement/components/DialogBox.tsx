                ...
                <DialogContent dividers>
                        ...
                        <table cellPadding="0" cellSpacing="0">
                            <tbody>
                                <tr>
                                    ...
                                    <td><b>Environment:</b> {ReactHtmlParser(content.Environment)}</td>
                                </tr>
                                <tr>
                                    <td ><b>Status:</b> {ReactHtmlParser(content.mrSTATUS)} </td>
                                    <td><b>Priority:</b> {priority[content.mrPRIORITY]}</td>
                                </tr>
                                <tr>
                                    <td colSpan={2}><b>Type of Change</b> {ReactHtmlParser(content.Change__bCategory)} </td>
                                </tr>
                            </tbody>
                        </table>
                    </Typography>
                    <Typography gutterBottom>
                        <table cellPadding="0" cellSpacing="0">
                            <tbody>
                                <tr>
                                    <td><b>Implementer:</b> {content.Change__bImplementer} </td>
                                </tr>
                                <tr>
                                    <td><b>Technical Approver:</b> {ReactHtmlParser(content.Technical__bApprover)} </td>
                                </tr>
                                <tr>
                                    <td><b>Business Approver</b> {ReactHtmlParser(content.Business__bApprover)} </td>
                                </tr>
                                <tr>
                                    <td><b>CAB Approver</b> {ReactHtmlParser(content.CAB__bApprover)} </td>
                                </tr>
                            </tbody>
                        </table>
                    </Typography>
